       ...
       <Box  p={20} mx={50} >
        <Box className={classes.styleTop}>
          <Grid  styles={{inner:{alignItems:"center"}}} >
            ...
            <Grid.Col className={classes.container} span={{ base: 12, md: 6, lg: 6 }}>
                <div>
            ...
            <Text className={classes.font}>
              ...
              <br />
              <Text fw={400} fz={20}>الأن التعلم عن بعد اصبح اسهل</Text>

                <Group className={classes.gap} mt={15}>
                    <Link to={"/"}  className={classes.linkOne}>انضم لنا الان</Link>
                    <Link to={"/"}  className={classes.linkTwo}>نبذة عنا</Link>
                </Group>
                </div>
            </Grid.Col>

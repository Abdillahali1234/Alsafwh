import { Avatar, Box, Container, Group, Text, useComputedColorScheme } from "@mantine/core";
...
export default function AllFeedback() {
  ...
  return (
    <Container
      my={50}
      className={computedColorScheme=='light'? classes.topParentLight : classes.topParentDark}
    >
        <div className={classes.parent}>
      <Box
        className={`${
          computedColorScheme == "light" ? classes.styleBackLight : classes.styleBackDark
        }`}>
        <Text
          className={`${classes.titleStyle} ${computedColorScheme == "light" ? classes.titleLight : classes.titleDark}`}>
         كل الاراء
        </Text>
      </Box>
    </div>
